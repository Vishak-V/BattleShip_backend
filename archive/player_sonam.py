...
def start_game(player1, player2):
    ...
    def make_board(player):
        ...
        board_str = subprocess.run(['python', f'{player.name}.py', 'initialize' ], capture_output=True, text = True).stdout
    ...
    def get_player_move(current_player):
        ...
        move_str = subprocess.run(['python', os.path.join(uploads_dir, current_player.script), ship_grid_string, attack_grid_string], capture_output=True, text = True).stdout
...
def play_bots(bot1:str,bot2:str):
    ...
    player1 = Player(bot1.removesuffix(".py"))
    player2 = Player(bot1.removesuffix(".py"))
...
#play_bots("2ab7b153-4092-4be8-8095-180bdd95bda0_Player1.py", "2ab7b153-4092-4be8-8095-180bdd95bda0_Player2.py")
