...
def start_game(player1, player2):
    ...
    def make_board(player):
        ...
        board_str = subprocess.run(['py', os.path.join(uploads_dir, player.script), 'initialize'], capture_output=True, text = True).stdout
    ...
    def get_player_move(current_player):
        ...
        move_str = subprocess.run(['py', os.path.join(uploads_dir, current_player.script), ship_grid_string, attack_grid_string, ' '.join(current_player.moves_list)], capture_output=True, text = True).stdout
