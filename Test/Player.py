...
def start_game(player1, player2):
    ...
    def get_player_move(current_player):
        ...
        move_str = subprocess.run(['py', current_player.script, ship_grid_string, attack_grid_string, ' '.join(current_player.moves_list)], capture_output=True, text = True).stdout
...
player1 = Player("AI_BOT_1")
player2 = Player("AI_BOT_2")
